 ...
 */
module.exports = function (hex, type = "AUTO", alternate = false) {
  if (typeof type === "object")
    return unMarshalBinaryLengthPrefixed(
      Buffer.from(hex, "hex"),
      type,
      undefined,
      alternate
    ...
    return unMarshalBinaryLengthPrefixed(
      Buffer.from(hex, "hex"),
      Object.assign({}, AUTO_TYPE),
      typeFactory,
      alternate
    ).val;
  } else
    throw "type should be one of the built-in types of passed in as object";
};
